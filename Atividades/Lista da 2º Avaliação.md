...
$$\begin{align*}
i^{2}-3i-19 &\equiv 0 \pmod{17} \text{ Multiplicar por 4}a\\
4i^{2}-12i-76 &\equiv 0 \pmod{17} \text{ Completando os Quadrados}\\
(2i-3)^{2} &\equiv 85 \pmod{17} \text{ Somando 9 dos dois lados}
\end{align*}$$
